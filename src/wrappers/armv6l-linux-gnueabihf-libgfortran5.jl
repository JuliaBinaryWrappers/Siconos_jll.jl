# Autogenerated wrapper script for Siconos_jll for armv6l-linux-gnueabihf-libgfortran5
...
JLLWrappers.@declare_library_product(libsiconos_externals, "libsiconos_externals.so.6")
JLLWrappers.@declare_library_product(libsiconos_numerics, "libsiconos_numerics.so.6")
function __init__()
